...
class NewMessageViewModel @Inject constructor() : ViewModel() {
    ...
    private val viewModelState = MutableStateFlow(NewMessagesViewModelState(isLoading = true))
...
private data class NewMessagesViewModelState(
    ...
    fun toUiState(): NewMessageUiState =
        if (users == null) {
            NewMessageUiState.NoChannels(
                isLoading = isLoading,
                errorMessages = errorMessages,
                searchInput = searchInput
            )
        } else {
            NewMessageUiState.HasChannels(
                users = users,
