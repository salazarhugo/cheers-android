...
sealed class CreatePostUIAction {
    ...
    data object OnMoreOptionsClick : CreatePostUIAction()
    data object OnAddDrinkClick : CreatePostUIAction()
    data object OnAddPeopleClick : CreatePostUIAction()
    data object OnCreateDrinkClick : CreatePostUIAction()
